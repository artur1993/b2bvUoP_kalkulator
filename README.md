...
-   **Implementation**: Translations are managed in `frontend/src/locales/en/translation.json` and `frontend/src/locales/pl/translation.json`.
...
```
After running frontend tests, open `frontend/coverage/index.html` in your browser to view the detailed report.
...
### Project Structure
The project follows a split backend/frontend structure:
- `.ai/`: Contains AI-related instructions and session state.
- `backend/`: Flask API and calculation code.
...
- `data/dane_wejsciowe_kalkulator.json`: Data file with all constants and parameters for calculations.
