    ...
    if (params.has("b2b_invoice")) {
      payload.b2bData = {
        monthly_invoice_amount:
          parseFloat(params.get("b2b_invoice")) ||
          initialState.b2bData.monthly_invoice_amount,
    ...
    if (params.has("uop_salary")) {
      payload.uopData = {
        monthly_gross_salary:
          parseFloat(params.get("uop_salary")) ||
          initialState.uopData.monthly_gross_salary,
      };
    }
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      dispatch({
        ...
        payload:
          "Failed to fetch results. Please check the console for more details.",
      });
    }
  };
