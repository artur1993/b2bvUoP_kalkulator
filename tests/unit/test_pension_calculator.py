...
def test_calculate_pension_details_positive_scenario_12k():
...
def test_calculate_pension_details_positive_scenario_25k():
...
def test_calculate_pension_details_zero_salary():
...
def test_calculate_pension_details_savings_allocation():
